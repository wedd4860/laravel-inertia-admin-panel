                    ...
                    <ul>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage("/kr/gz/service/status")
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link href={route("kr.gz.service.status.show")}>
                                    <font className="align-middle">
                                        게임스타트 상태
                                    </font>
                                </Link>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage("/kr/gz/block/account")
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link href={route("kr.gz.block.account.index")}>
                                    <font className="align-middle">
                                        마상 계정
                                    </font>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            ...
                            >
                                <Link href={route("kr.gz.banner.main.index")}>
                                    <font className="align-middle">
                                        메인 배너
                                    </font>
                                </Link>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage("/kr/gz/link/download")
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link href={route("kr.gz.link.download.show")}>
                                    <font className="align-middle">
                                        다운로드 링크
                                    </font>
                                </Link>
