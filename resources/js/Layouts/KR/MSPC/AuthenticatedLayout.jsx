                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage(
                                                "/kr/mspc/creators/group",
                                                "^/kr/mspc/creators/\\d+/group/"
                                            )
                            ...
                            >
                                ...
                                >
                                    <font className="align-middle">그룹</font>
                                </Link>
                            </li>
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage(
                                                "/kr/mspc/creators/creator",
                                                "^/kr/mspc/creators/\\d+/(creator|sponsorship)"
                                            )
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link
                                    href={route(
                                        "kr.mspc.creators.creator.index"
                                    )}
                                >
                                    <font className="align-middle">
                                        크리에이터
