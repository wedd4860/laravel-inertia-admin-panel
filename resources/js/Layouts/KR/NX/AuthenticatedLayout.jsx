                    ...
                    <ul>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage("/kr/nx/service/status")
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link href={route("kr.nx.service.status.show")}>
                                    <font className="align-middle">
                                        서비스 상태 관리
                                    </font>
                                </Link>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            <li
                                className={`text-sm py-1 border-l pl-4 hover:border-sky-500 hover:text-sky-500
                                        ${
                                            isPage("/kr/nx/block/account")
                                                ? "border-sky-500 text-sky-500 font-semibold"
                                                : ""
                                        }`}
                            >
                                <Link href={route("kr.nx.block.account.index")}>
                                    <font className="align-middle">
                                        마상 계정
                                    </font>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            ...
                            >
                                <Link href={route("kr.nx.banner.main.index")}>
                                    <font className="align-middle">
                                        메인 배너
                                    </font>
                                </Link>
                        ...
                        <ul className="text-slate-500 border-slate-200">
                            ...
                            >
                                <Link href={route("kr.nx.transfer.daum.index")}>
                                    <font className="align-middle">
                                        다음 채널링 이관
                                    </font>
                                </Link>
