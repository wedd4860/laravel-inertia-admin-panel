...
const Edit = ({ auth, member }) => {
    ...
    const onSubmit = (e) => {
        ...
        put(route("kr.cs.member.info.update", data.member_srl), {
            preserveScroll: true,
            onSuccess: ({ props }) => {
                if (props.success) {
            ...
            <div className="p-6">
                ...
                <div className="rounded-lg shadow border">
                    ...
                    <div className="grid grid-cols-2 p-6 gap-4">
                        ...
                        <div className="col-span-1">
                            <div>
                                <InputLabel value="속한그룹" />
                                {data.member_group &&
                                    data.member_group.map((group) => (
                                        <MemberGroupButton
                                            key={group.group_srl}
                                            group_srl={group.group_srl}
                                            className="mt-1 bg-gray-200 border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-300 py-1 px-2 text-gray-800 rounded transition-all mr-3 text-xs"
                                        />
                                    ))}
                            </div>
                        </div>
                        <div className="col-span-1">
                            <div>
                                <InputLabel value="관리자 YN" />
                                <p className="ml-2">{data.is_admin}</p>
                            </div>
                        </div>
                        <div className="col-span-1">
                            <div>
                        ...
                        <div className="col-span-1">
                            <div>
                                <InputLabel htmlFor="birthday" value="생일" />
                                <DatePicker
                                    id="birthday"
                        ...
                        <div className="col-span-1">
                            <div>
                                <InputLabel
                                    htmlFor="member_login_device_switch"
                                    value="새기기 로그인 알림"
                                />
                                <SelectInput
                                    name="member_login_device_switch"
                                    id="member_login_device_switch"
                                    className="mt-1 w-full text-sm leading-4"
                                    onChange={(e) =>
                                        setData(
                                            "member_login_device_switch",
                                            e.target.value
                                        )
                                    }
                                    value={data.member_login_device_switch}
                                >
                                    <option value="">선택</option>
