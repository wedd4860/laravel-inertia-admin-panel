...
const Edit = ({ auth, abroad, success }) => {
    ...
    const onSubmit = (e) => {
        ...
        patch(route("kr.cs.block.abroad.update"), {
            preserveScroll: true,
            onSuccess: ({ props }) => {
                if (props.success) {
            ...
            <div className="p-6">
                ...
                <div className="rounded-lg shadow border">
                    <div className="bg-gray-50 border-b-2 border-gray-500 p-3">
                        <p className="font-bold">해외 IP 차단 ON/OFF</p>
                    </div>
