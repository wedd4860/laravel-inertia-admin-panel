...
const Index = ({ auth, members, queryParams = null }) => {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        router.get(route("kr.cs.security.service.index"), queryParams);
    };
    ...
    const handleDeleteSecurity = (iMemberSrl, strType) => {
    ...
    const onSubmit = (e) => {
        ...
        destroy(
            route("kr.cs.security.service.destroy", {
                memberSrl,
                type,
            }),
            {
    ...
    return (
        <AuthenticatedLayout member={auth.member}>
            <Head title="고객보안관리 : 전화/OTP/해외IP차단 - index" />
                    ...
                    <table className="w-full table-auto text-sm text-left">
                        <thead className="text-xs uppercase bg-gray-50 border-b-2 border-gray-500">
                            <tr className="text-nowrap text-center">
                                ...
                                <th className="px-3 py-3">
                                    <div className="min-w-24">타입</div>
                                </th>
                                <th className="px-3 py-3">
                                    <div className="min-w-24">
                                        전화번호/OTP비밀키/해외IP차단상태
                                    </div>
                                </th>
                                <TableHeading
                                    name="regDate"
                        ...
                        <thead className="uppercase border-b-2 border-gray-500">
                            <tr className="text-nowrap">
                                ...
                                <th className="px-3 py-2">
                                    <SelectInput
                                        className="w-40 text-sm leading-4"
                                ...
                                <th className="px-3 py-2">
                                    <TextInput
                                        className="w-full text-sm leading-4"
                                        placeholder="extra_vars"
                                        defaultValue={queryParams.extra_vars}
                                        onBlur={(e) =>
                                            searchFieldChanged(
                                                "extra_vars",
                                                e.target.value
