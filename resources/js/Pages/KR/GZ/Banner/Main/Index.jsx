...
const Index = ({ auth, banners, queryParams = null, success }) => {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        router.get(route("kr.gz.banner.main.index"), queryParams);
    };
    ...
    const onSubmit = (e) => {
        ...
        destroy(route("kr.gz.banner.main.destroy", data.idx), {
            preserveScroll: true,
            onSuccess: ({ props }) => {
                if (props.success != "") {
    ...
    return (
        <AuthenticatedLayout member={auth.member}>
            <Head title="배너 관리 : 건즈 메인 배너 - index" />

            <div className="px-6 py-4 overflow-hidden shadow-sm">
                <Link
                    href={route("kr.gz.banner.main.create")}
                        ...
                        <thead className="text-xs uppercase bg-gray-50 border-b-2 border-gray-500">
                            <tr className="text-nowrap text-center">
                                ...
                                <th className="px-3 py-3">
                                    <div className="min-w-24">이미지 URL</div>
                                </th>
                                <th className="px-3 py-3">
