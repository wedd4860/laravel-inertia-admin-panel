...
const Edit = ({ auth, banner, success }) => {
    ...
    const onSubmit = (e) => {
        ...
        patch(route("kr.fh.banner.bottomright.update", data.idx), {
            preserveScroll: true,
            onSuccess: ({ props }) => {
                if (props.success) {
    ...
    return (
        <AuthenticatedLayout member={auth.member}>
            <Head title="배너 관리 : 출조낚시왕 메인 우측 하단 배너 수정 - edit" />
            ...
            <div className="p-6">
                ...
                <div className="rounded-lg shadow border">
                    <div className="bg-gray-50 border-b-2 border-gray-500 p-3">
                        <p className="font-bold">메인 우측 하단 배너 수정</p>
                    </div>
                    <div className="grid grid-cols-2 p-6 gap-4">
                        <div className="col-span-2">
                            <div>
                                <InputLabel value="사이트" />
                                <p className="ml-2 font-bold">{banner.siteName}</p>
                            </div>
                        </div>
