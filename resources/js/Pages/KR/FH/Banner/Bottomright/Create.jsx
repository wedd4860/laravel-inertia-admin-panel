...
const Create = ({ auth }) => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(route("kr.fh.banner.bottomright.store"), {
            preserveScroll: true,
            onSuccess: ({ props }) => {},
            onError: (errors) => {},
        });
    ...
    return (
        <AuthenticatedLayout member={auth.member}>
            <Head title="배너 관리 : 출조낚시왕 메인 우측 하단 배너 추가 - create" />

            <div className="p-6">
                <div className="rounded-lg shadow border">
                    <div className="bg-gray-50 border-b-2 border-gray-500 p-3">
                        <p className="font-bold">메인 우측 하단 배너 추가 - 247*120</p>
                    </div>
                    ...
                    <div className="p-3 bg-gray-50 border-t-2 text-right">
                        <Link
                            href={route("kr.fh.banner.bottomright.index")}
