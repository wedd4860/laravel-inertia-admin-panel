...
const Create = ({ auth }) => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(route("kr.nx.block.account.store"), {
            preserveScroll: true,
            onSuccess: ({ props }) => {},
            onError: (errors) => {},
        });
            ...
            <div className="p-6">
                <div className="rounded-lg shadow border">
                    ...
                    <div className="grid grid-cols-2 p-6 gap-4">
                        ...
                        <div className="col-span-1">
                            <div>
                                <InputLabel
                                    htmlFor="date"
                                    value="차단날짜를 입력해주세요. 공백시 무기한입니다."
                                />
                                <DatePicker
                                    id="date"
                                    autoComplete="off"
                                    wrapperClassName="mt-1 w-full"
                                    className="mt-1 border-gray-300 w-full text-sm leading-4 rounded-md"
                                    selected={data.date}
                    ...
                    <div className="p-3 bg-gray-50 border-t-2 text-right">
                        <Link
                            href={route("kr.nx.block.account.index")}
